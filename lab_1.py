...
def main():
    ...
    while True:
        ...
        if choice == 1:
            ...
            print("1.Вывести на экран все делители числа. Число вводить с клавиатуры. – 1 балл ")
            lab1Task1()
            print("Задание кончилось")
        elif choice == 2:
            print("Задание началось")
            print("2.С клавиатуры вводится строка . Разработать программу , которая реализует указанные действия .\n "
                  "а) подсчитывает 	количество 	слов;\n "
                  "б) вывести на экран самое длинное слово. – 2 балла ")
            lab1Task2()
            print("Задание кончилось")
        elif choice == 3:
            print("Задание началось")
            print("3.На вход программе подается натуральное число n  n≥2, а затем n целых чисел.\n "
                  "Напишите программу, которая создает из указанных чисел список, состоящий из сумм соседних чисел. – 2 балла ")
            lab1Task3()
            print("Задание кончилось")
        elif choice == 4:
            print("Задание началось")
            print("4.Отсортируйте  словарь  по ключу  в  порядке  возрастания  и убывания. \n "
                  "Вывести на  экран  элемент  с  максимальным  значением.– 2 балла ")
            lab1Task4()
            print("Задание кончилось")
        elif choice == 5:
            print("Задание началось")
            print("5.Реализуйте  программу  «Кондитерская»,  которая  будет  включать в  себя  шесть  пунктов  меню.\n"
                  ...
                  "4.Всю информацию. \n"
                  "5.Покупка В  пункте «Покупка»  необходимо  совершить  покупку,с клавиатуры вводите название продукции и его кол-во, n –  выход из программы. Посчитать цену выбранных товаров и сколько товаров осталось в изначальном списке.  На выходе должен быть чек.\n"
                  "6.До свидания –  2 балла \n")
            lab1Task5()
            print("Задание кончилось")
        elif choice == 6:
            print("Задание началось")
            print("Дан кортеж целых чисел. Отсортировать его в порядке убывания. Вывести первый и последний элемент кортежа.  – 1 балл ")
            lab1Task6()
            print("Задание кончилось")
        else :
            break
